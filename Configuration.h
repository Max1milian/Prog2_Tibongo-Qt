...
public:
  ...
  static const int SPIELFELD_LOESUNG_X =
      (SPIELFELD_DIMENSION_X + SPIELFELD_OFFSET_X) / 2 - 2;
  static const int SPIELFELD_LOESUNG_Y =
      (SPIELFELD_DIMENSION_Y + SPIELFELD_OFFSET_Y) / 2 - 2;
